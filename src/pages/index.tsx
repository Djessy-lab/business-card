    ...
    <>
      ...
      <div className="flex h-[calc(100vh-4rem)] flex-col items-center justify-center bg-gradient-to-br from-rose-500 to-purple-600">
        ...
        <div className="mt-12 flex justify-center">
          <button type="button" onClick={publish} className="rounded-full bg-black/10 px-10 py-3 font-semibold text-white no-underline transition hover:bg-black/20">
            Publish
          </button>
        </div>
      </div>
